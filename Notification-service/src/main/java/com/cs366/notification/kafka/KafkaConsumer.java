...
public class KafkaConsumer {
    ...
    public void riderAssigned(RiderAssignedEvent payload) {
        // Print statement
        NotiService.sendNoti(payload.getRiderId() + "Assigned!");
    }
    ...
    public void riderDelivered(RiderDeliveredFoodEvent payload) {
        // Print statement
        NotiService.sendNoti(payload.getRiderId() + "Delivered!");
    }
    ...
    public void riderPicked(RiderPickedUpFoodEvent payload) {
        // Print statement
        NotiService.sendNoti(payload.getRiderId() + "Pickup Food!!");
    }
    ...
    public void orderDetailToChef(OrderDetailEvent payload) {
        // Print statement
        NotiService.sendNoti(payload.getNote() + "OrderDetail");
    }
    ...
    public void paymentEvent(PaymentEvent payload) {
        // Print statement
        NotiService.sendNoti(payload.getStatus() + " : " + payload.getPaymentId());
    }
